%[AVT, CRI_ext, x_cr, y_cr, Jph]= calculationTMMforPython(10, 0, 30, 100,
%30, 0, 10 ); %Terminalden fonksiyonu bu sekilde cagır



function [AVT, CRI_ext, x_cr, y_cr, Jph]= calculationTMMforPython(t1, t2, t3, t4 ,t5, t6, t7)
angle = 0;
thick_film_index = [];

%filename = "forPython.xlsx";
...
layers(2) = {'WO3'}; thickness(2)= t1     ;%nm
layers(3) = {'Ag'}; thickness(3) = t2       ;%50 ;%nm
layers(4) = {'ZnO'}; thickness(4) = t3       ;%30 ;%nm
layers(5) = {'PTB7_PCBM'}; thickness(5) = t4 ;%100 ;%nm
layers(6) = {'MoO3'}; thickness(6) = t5   ;%nm
layers(7) = {'Ag'}; thickness(7) = t6     ;%nm
layers(8) = {'WO3'}; thickness(8) = t7    ;%nm

layers(9) = {'Vac'}; thickness(8) =       1 ;%nm
