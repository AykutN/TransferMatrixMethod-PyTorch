function plot_TMM_CRI(layers, thickness, thick_film_index,angle,filename)
...
CRIheader = {'Chromacity Distance','CCT      ','CRI_gen','CRI_ext','R1    ','R2    ','R3    ','R4    ','R5    ','R6    ','R7    ','R8    ','R9    ','R10   ','R11   ','R12   ','R13   ','R14   ','R15   '};
c_head = [DC,CCT,CRI_gen,CRI_ext,R1,R2,R3,R4,R5,R6,R7,R8,R9,R10,R11,R12,R13,R14,R15];
cri_head = cell(2,19);
cri_head = {'Chromacity Distance','CCT','CRI_gen','CRI_ext','R1','R2','R3','R4','R5','R6','R7','R8','R9','R10','R11','R12','R13','R14','R15';DC',CCT',CRI_gen',CRI_ext',R1',R2',R3',R4',R5',R6',R7',R8',R9',R10',R11',R12',R13',R14',R15'}
cri_head(1,:) = CRIheader;
cri_head(2,:) = num2cell([c_head]);


writecell(cri_head,filename,'sheet',4);
